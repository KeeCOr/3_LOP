...
export default function StopAtTileModal({ state, dispatch }: Props) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-3">
      <div className="bg-gray-900 rounded-xl p-5 w-full max-w-[320px] max-h-[calc(100vh-1.5rem)] overflow-y-auto text-white border-t-2 border-blue-500 shadow-2xl">
          ...
          {tiles.map(({ tileId }) => {
            ...
            return (
              <button
                ...
                className="flex min-w-0 items-center justify-between gap-2 px-3 py-2 bg-blue-900/60 hover:bg-blue-800/80 border border-blue-700 rounded-lg text-left">
                <div>
        ...
        <button
          ...
          className="w-full min-w-0 py-2 bg-gray-700 hover:bg-gray-600 rounded-lg text-sm font-semibold whitespace-normal break-words">
